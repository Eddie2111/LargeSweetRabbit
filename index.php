      ...
      <div class="section-light about-me" id="about-me">
        <div class="container">
          <div class="column is-12 about-me">
            <h1 class="title has-text-centered section-title">Welcome</h1>
          </div>
          ...
          <div class="columns is-multiline">
            ...
            <img
            class="is-rounded"
            src="http://cdn.cnn.com/cnnnext/dam/assets/160726150143-us-beautiful-hotels-17-bellagio-2.jpg"
            alt=""
            />
            <img
            class="is-rounded"
            src="https://picsum.photos/516/324"
            alt=""/>
            <img
            class="is-rounded"
            ...
            <img
            class="is-rounded"
            src="https://picsum.photos/436/154"
            alt="" />
            </div>
          </div>
          <img
            class="is-rounded"
            src="https://picsum.photos/521/234"
            alt="" />
        </div>
      </div>
        ...
        <div class="container">
          ...
          >
            <div class="column is-12">
              <h1 class="title has-text-centered section-title">Our Hotel</h1>
            </div>
